...
const CryptoDetailsContainer = ({data, cryptoDetails, time, stats, setTimeperiod, coinHistory, genericStats}) => {
    return (
        ...
        <Col className="coin-heading-container">
          ...
          <p>
            Цена монеты {cryptoDetails.name} в долларах (USD). А также статистика цен, рыночная капитализация и объём торгов.
          </p>
        </Col>
        <Select
          defaultValue="7d"
